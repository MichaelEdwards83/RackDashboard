...
# 2. Optimized REST Integration (Fetches ALL data in ONE request)
rest:
  - resource: http://localhost:8000/api/ha
    ...
    sensor:
      ...
      - name: "Dashboard Bay A"
        ...
        value_template: "{{ value_json['28-00000035bdc5']['temp'] }}"
        unit_of_measurement: "°F"
        device_class: temperature
        json_attributes_path: "$.['28-00000035bdc5']"
        json_attributes:
          - led_rgb
          - status
      ...
      - name: "Dashboard Bay B"
        ...
        value_template: "{{ value_json['28-000000390962']['temp'] }}"
        unit_of_measurement: "°F"
        device_class: temperature
        json_attributes_path: "$.['28-000000390962']"
        json_attributes:
          - led_rgb
          - status
      ...
      - name: "Dashboard Bay C"
        ...
        value_template: "{{ value_json['28-00000037ac11']['temp'] }}"
        unit_of_measurement: "°F"
        device_class: temperature
        json_attributes_path: "$.['28-00000037ac11']"
        json_attributes:
          - led_rgb
          - status
      ...
      - name: "Dashboard Ambient"
        ...
        value_template: "{{ value_json['28-00000036013b']['temp'] }}"
        unit_of_measurement: "°F"
        device_class: temperature
        json_attributes_path: "$.['28-00000036013b']"
        json_attributes:
          - led_rgb
          - status
      ...
      - name: "Dashboard Exhaust"
        ...
        value_template: "{{ value_json['28-0000003634bb']['temp'] }}"
        unit_of_measurement: "°F"
        device_class: temperature
        json_attributes_path: "$.['28-0000003634bb']"
        json_attributes:
          - led_rgb
          - status

# 3. Light Entity (Master Brightness Control)
# Modern "template" syntax with SAFETY CHECKS
template:
  - light:
      - name: "Rack LEDs"
        unique_id: "rack_dashboard_led_controller"
        
        # State: On if brightness > 0 (Added defaults to prevent startup errors)
        state: "{{ state_attr('sensor.rack_dashboard_settings', 'brightness') | int(0) > 0 }}"
        
        # Brightness: 0-255 (Added defaults)
        level: "{{ state_attr('sensor.rack_dashboard_settings', 'brightness') | int(0) }}"
